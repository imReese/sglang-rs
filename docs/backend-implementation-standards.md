...
This document is the working contract for runtime, device, and KV-transfer
implementation work in sglang-rs. New backend features should satisfy these
rules before being considered complete.
